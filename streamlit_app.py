...
if sub_category:
    ...
    grouped_sales = filtered_data.groupby(['Date', 'Sub_Category'])['Sales'].sum().reset_index()
    sales_pivot = grouped_sales.pivot(index='Date', columns='Sub_Category', values='Sales')
